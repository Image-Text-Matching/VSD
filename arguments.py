...
def get_argument_parser():
    ...
    parser.add_argument('--proto_path', type=str, default='proto_data',
                        help='the path of prototype data')
    parser.add_argument("--sk_epsilon", default=0.05, type=float,
                        help="regularization parameter for Sinkhorn-Knopp algorithm")
    parser.add_argument("--sinkhorn_iterations", default=3, type=int,
                        help="number of iterations in Sinkhorn-Knopp algorithm")
    parser.add_argument("--proto_temperature", default=0.1, type=float,
                        help="temperature parameter in ProtoContrastiveLoss")
