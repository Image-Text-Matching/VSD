...
class VSEModel(object):
    ...
    def train_emb(self, images, captions, teacher_aux_captions, teacher_captions, opt, lengths, image_lengths=None,
        ...
        # compute loss
        img_feat, img_len, img_emb_, img_emb_notnorm, img_emb_pre_pool = img_emb
        cap_feat, cap_len, cap_emb_, cap_emb_notnorm, cap_emb_pre_pool = cap_emb
        proto_loss = self.proto_criterion(img_emb_, cap_emb_)
