...
def main():
    ...
    for base in weights_bases:
        ...
        if opt.dataset == 'coco':
            ...
            # Evaluate COCO 5K
            evaluation.evalrank_bge(model_path, split='testall', fold5=True, save_path=save_path, data_path=opt.data_path)
        else:
            # Evaluate Flickr30K
            evaluation.evalrank_bge(model_path, split='test', fold5=False, save_path=save_path, data_path=opt.data_path)
